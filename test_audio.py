from spotty.audio.robot_interface import AudioManager, AudioConfig, ChatClient, WakeWordDetector, WakeWordConfig, VoiceInterface, VoiceInterfaceConfig
import queue
import os
...
def test_audio_recording():
    ...
    try:
        ...
        # Record audio
        recorded_file = audio_manager.record_audio(
