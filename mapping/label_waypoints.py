...
if __name__ == '__main__':
    ...
    # Load the map.
    graph, waypoints, waypoint_snapshots, edge_snapshots, anchors, anchored_world_objects = load_map("/Users/shuk/Desktop/spot/practical-seminar-mobile-robotics/spot-sdk/python/examples/graph_nav_command_line/downloaded_graph/")
    # print("waypoints: ", waypoints)
    print(type(waypoints))
    print("waypoints: ", waypoints.keys())
    keys = waypoints.keys()
    values = list(waypoints.values())
